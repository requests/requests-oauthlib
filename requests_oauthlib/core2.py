...
class OAuth2Client(requests.Session):
    """Versitile OAuth 2 Client extension to requests.Session.
    ...
    def __init__(self, client_id, oauth2_client=None, auto_refresh_url=None,
        ...
        :param oauth2_client: oauthlib.oauth2.Client to be used. Default is
        ...
        self._client = oauth2_client or WebApplicationClient(
    ...
    def request(self, method, url, data=None, headers=None, **kwargs):
        ...
        return super(OAuth2Client, self).request(method, url,
